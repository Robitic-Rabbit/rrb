...
async function main() {
  try {
    ...
    console.log("mintingSpecialNumber : " + mintingSpecialNumber);

    //POLY
    if (chainID == '137') {

      const weaponContract = await ethers.getContractAt(ABI, "0x9c5a116e2dAd3047dc4660D19bc060d9C9dd29Ed");

      /*const tx = await weaponContract.mint(userAddress, mintingSpecialNumber, {
          value: "1000000000000000" // Send 0.001 MATIC as msg.value
        });*/
